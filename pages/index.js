    ...
    <>
      <Box
        styleSheet={{
          ...
          backgroundImage: 'url(https://virtualbackgrounds.site/wp-content/uploads/2020/07/iron-man-suits-on-tony-starks-lab-1536x864.jpg)',
          ...
          >
            ...
            <TextField
              ...
              onChange={function handler(event) {
                ...
                // Trocar o valor da variável
                // através do React e ele avisa quem for preciso
                // if (numeroCaracteresDigitados > 2) {
                setUsername(valor);
                // } else {
                // setUsername('')
                // }
